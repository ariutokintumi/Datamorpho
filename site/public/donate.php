    ...
    <section>
        <div class="container">
            ...
            <div class="section-actions" style="margin-top: 2rem;">
                <a class="btn btn-primary" href="<?php echo htmlspecialchars($givethUrl, ENT_QUOTES, 'UTF-8'); ?>">Support via Giveth</a>
                <a class="btn btn-secondary" href="https://datamorpho.io/roadmap.php">View the Roadmap</a>
                <a class="btn btn-secondary" href="https://datamorpho.io/community.php">Open Community</a>
            </div>
        </div>
    </section>
</main>
